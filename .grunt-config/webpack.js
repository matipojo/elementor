...
const entry = {
	...
	'app': path.resolve( __dirname, '../apps/assets/js/index.js' ),
	'app-loader': path.resolve( __dirname, '../apps/assets/js/app-loader' ),
	'app-packages': path.resolve( __dirname, '../apps/assets/js/app-packages' ),
