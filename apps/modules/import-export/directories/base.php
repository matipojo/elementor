<?php
namespace Elementor\Apps\Modules\ImportExport\Directories;

use Elementor\Apps\Modules\ImportExport\Export;
use Elementor\Apps\Modules\ImportExport\Import;
use Elementor\Apps\Modules\ImportExport\Iterator;
...
abstract class Base {
	...
	private function register_directories() {
		 ...
		 * @param Elementor\Apps\Modules\ImportExport\Directories\Base $this The base class instance.
		 */
