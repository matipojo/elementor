	...
	public function content_template() {
		...
		<#
			...
			const getButtonLabel = ( mediaType ) => {
				switch( mediaType ) {
					case 'image':
						return '<?php echo esc_html__( 'Choose Image', 'elementor' ); ?>';

					case 'video':
						return '<?php echo esc_html__( 'Choose Video', 'elementor' ); ?>';

					case 'svg':
						return '<?php echo esc_html__( 'Choose SVG', 'elementor' ); ?>';

					default:
						return '<?php echo esc_html__( 'Choose File', 'elementor' ); ?>';
				}
			}
		#>
